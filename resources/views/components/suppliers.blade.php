...
<section class="bg-white py-12 sm:py-14" aria-label="Energy suppliers we compare">
    <div class="mx-auto max-w-7xl px-5 sm:px-8 lg:px-10">
        ...
        {{-- Mobile: auto-scrolling logo marquee --}}
        <div class="supplier-marquee-mask relative mt-8 -mx-5 overflow-hidden sm:hidden" aria-hidden="true">
            <ul class="supplier-marquee flex w-max items-center gap-10 px-5">
                @foreach (array_merge($suppliers, $suppliers) as [$file, $alt, $height])
        ...
        <p class="sr-only">
            We compare deals from Octopus Energy, E.ON, ScottishPower, British Gas, OVO Energy, and Utilita.
        </p>
