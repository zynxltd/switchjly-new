...
<section id="faqs" class="scroll-mt-24 bg-white py-16 sm:py-20" aria-labelledby="faqs-heading">
    <div class="mx-auto max-w-6xl px-5 sm:px-8 lg:px-10">
        <div class="text-center">
            ...
            <h2
                id="faqs-heading"
                class="mt-3 text-3xl font-extrabold tracking-tight text-brillia-ink sm:text-4xl"
            >
        ...
        <div class="mt-12 grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
            ...
            <div class="relative mx-auto w-full max-w-md lg:mx-0 lg:max-w-none">
                <img
                    ...
                    alt="Chat showing How does Brillia work? We compare. You save."
                    width="926"
                    height="490"
            ...
            <div class="space-y-3" x-data="{ open: null }">
                @foreach ($faqs as $index => $faq)
                    <div class="overflow-hidden rounded-2xl border border-brillia-border bg-white">
                        <button
                            type="button"
                        ...
                        >
                            <span class="text-sm font-semibold text-brillia-ink sm:text-[0.975rem]">
                                {{ $faq['q'] }}
                            </span>
                            <span
                                ...
                                :class="open === {{ $index }} ? 'rotate-45 bg-brillia-lime text-brillia-ink' : ''"
                                aria-hidden="true"
                            >+</span>
                        </button>
                        ...
                        <div
                            ...
                            class="px-5 pb-4 text-sm leading-relaxed text-brillia-muted sm:px-6"
                        >
                            {{ $faq['a'] }}
                        </div>
                    </div>
