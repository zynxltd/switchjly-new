...
>
    ...
    >
        <div
            ...
            @click.outside="close()"
        >
            <div class="h-1.5 bg-brillia-lime" aria-hidden="true"></div>

            <button
                type="button"
                class="absolute right-3 top-4 z-10 inline-flex h-9 w-9 items-center justify-center rounded-full bg-neutral-100 text-neutral-500 transition hover:bg-neutral-200 hover:text-brillia-ink"
                @click="close()"
            ...
            <div class="px-6 pb-7 pt-7 sm:px-8 sm:pb-8 sm:pt-8">
                <img
                    ...
                    alt="{{ config('company.product_name', 'Brillia Energy') }}"
                    class="h-8 w-auto"
                >
                ...
                <template x-if="!success">
                    <div>
                        ...
                        <h2 id="lead-popup-title" class="mt-2 text-2xl font-extrabold tracking-tight text-brillia-ink sm:text-[1.65rem]">
                        ...
                        <form class="mt-6 space-y-3" @submit.prevent="submit">
                            <div>
                                ...
                                <input
                                    ...
                                    class="w-full rounded-xl border border-brillia-border bg-white px-4 py-3.5 text-sm text-brillia-ink outline-none placeholder:text-neutral-400 focus:border-brillia-ink focus:ring-2 focus:ring-brillia-lime/40"
                                >
                            </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input
                                        ...
                                        class="w-full rounded-xl border border-brillia-border bg-white py-3.5 pl-4 pr-11 text-sm text-brillia-ink outline-none placeholder:text-neutral-400 focus:border-brillia-ink focus:ring-2 focus:ring-brillia-lime/40"
                                    >
                            ...
                            <button
                                type="submit"
                                class="inline-flex w-full items-center justify-between gap-2.5 rounded-full bg-brillia-lime py-3.5 pl-6 pr-2.5 text-sm font-bold text-brillia-ink transition hover:brightness-95 disabled:opacity-60"
                                :disabled="loading"
                            >
                        ...
                        <p class="mt-3.5 flex items-center justify-center gap-1.5 text-xs text-brillia-muted">
                            <svg class="h-3.5 w-3.5 shrink-0 text-brillia-ink" viewBox="0 0 14 14" fill="none" aria-hidden="true">
                ...
                <template x-if="success">
                    <div class="py-6 text-center">
                        <div class="mx-auto mb-4 inline-flex h-14 w-14 items-center justify-center rounded-full bg-brillia-lime text-brillia-ink">
                            <svg class="h-7 w-7" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                                <path d="M5 12.5 9.5 17 19 7.5" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                        </div>
                        <h3 class="text-xl font-extrabold tracking-tight text-brillia-ink">You're subscribed</h3>
                        <p class="mt-2 text-sm text-brillia-muted" x-text="message"></p>
                        <button
                            type="button"
                            class="mt-6 inline-flex items-center gap-2 rounded-full bg-brillia-black px-5 py-3 text-sm font-semibold text-white transition hover:bg-neutral-800"
                            @click="close()"
                        >
                            Keep browsing
                        </button>
