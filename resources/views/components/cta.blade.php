<section class="bg-white py-12 sm:py-16" aria-labelledby="cta-heading">
    <div class="mx-auto max-w-7xl px-5 sm:px-8 lg:px-10">
        <div class="rounded-[1.5rem] bg-brillia-black px-6 py-10 sm:rounded-[1.75rem] sm:px-10 sm:py-12 lg:px-14 lg:py-12 xl:px-16">
            <div class="grid items-center gap-10 lg:grid-cols-[1.15fr_1fr] lg:gap-12 xl:gap-16">
                ...
                <div class="min-w-0">
                    ...
                    >
                        ...
                        in just <span class="text-brillia-lime">60 seconds.</span>
                    </h2>
                    ...
                    <ul class="mt-6 flex flex-wrap items-center gap-x-5 gap-y-2.5 text-sm font-medium text-white">
                        @foreach (['Free', 'Fast', 'Trusted by 50,000+'] as $point)
                            <li class="inline-flex items-center gap-2">
                                <span class="inline-flex h-5 w-5 items-center justify-center rounded-full bg-brillia-lime text-brillia-black">
                ...
                <div class="relative min-w-0">
                    ...
                    >
                        <div class="min-w-0 flex-1">
                            <label class="relative block">
                                ...
                                <input
                                    ...
                                    aria-describedby="cta-postcode-error"
                                    @input="error = ''"
                                    class="w-full rounded-xl border-0 bg-white py-2.5 pl-3.5 pr-10 text-sm text-brillia-ink outline-none ring-0 placeholder:text-neutral-400 focus:ring-2 focus:ring-brillia-lime sm:py-3.5 sm:pl-4 sm:pr-11 sm:text-[0.9375rem]"
                                    :class="error && 'ring-2 ring-red-400'"
                                >
                            ...
                            <p class="mt-2.5 flex items-center gap-1.5 text-xs text-white/55 sm:mt-3 sm:text-sm" x-show="!error">
                        ...
                        <button
                            type="submit"
                            class="relative inline-flex shrink-0 items-center justify-center self-stretch rounded-xl bg-brillia-lime px-5 py-2.5 text-sm font-bold text-brillia-ink transition hover:brightness-95 sm:self-auto sm:px-6 sm:py-[0.95rem] sm:text-[0.9375rem]"
                        >
                            Compare now
                        </button>
                    </form>
