...
@section('title', 'Your usage — Switchly')
    ...
    <main class="mx-auto max-w-xl px-5 pb-16 sm:px-8">
        ...
        <form action="{{ route('compare.usage.store') }}" method="POST" class="mt-8 space-y-4">
            ...
            <section class="rounded-2xl border border-switchly-border bg-white p-5 sm:p-6">
                ...
                <p class="mt-3 text-sm text-switchly-muted">
            ...
            <p class="pt-1 text-center">
                <a href="{{ route('compare.details') }}" class="text-sm font-semibold text-switchly-muted underline underline-offset-2 hover:text-switchly-ink">
                    Back to details
                </a>
            </p>
        </form>
