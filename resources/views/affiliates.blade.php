...
@section('title', 'Affiliate programme — Partner with Brillia')
@section('meta_description', 'Earn commission promoting free UK energy comparisons with Brillia. Get a unique referral link, real-time tracking, and transparent payouts.')
        ...
        <div class="mx-auto max-w-7xl px-5 sm:px-8 lg:px-10">
            ...
            <div class="mx-auto mt-12 grid max-w-5xl gap-4 sm:grid-cols-3 sm:gap-5">
                @foreach ([
                    ...
                    <article class="rounded-[1.25rem] bg-white p-6 shadow-[0_10px_40px_rgba(0,0,0,0.06)] sm:p-7">
                        <h2 class="text-base font-bold tracking-tight text-brillia-ink sm:text-lg">{{ $card['title'] }}</h2>
                        <p class="mt-2 text-sm leading-relaxed text-brillia-muted">{{ $card['body'] }}</p>
                    </article>
                @endforeach
            </div>
            ...
            <ol class="mx-auto mt-12 grid max-w-5xl gap-5 sm:grid-cols-3 sm:gap-6">
                @foreach ([
                    ...
                    ['n' => '2', 'title' => 'Share your link', 'body' => 'Copy your referral URL from the portal and promote Brillia wherever your audience is.'],
                    ...
                    <li class="rounded-[1.25rem] bg-white p-7 shadow-[0_10px_40px_rgba(0,0,0,0.06)] sm:p-8">
                        <span class="inline-flex h-10 w-10 items-center justify-center rounded-full bg-brillia-lime text-base font-extrabold text-brillia-ink">
                            {{ $step['n'] }}
                        </span>
                        <h2 class="mt-5 text-lg font-bold tracking-tight text-brillia-ink">{{ $step['title'] }}</h2>
                        <p class="mt-2 text-sm leading-relaxed text-brillia-muted">{{ $step['body'] }}</p>
                    </li>
                @endforeach
            </ol>

            <div class="mx-auto mt-12 grid max-w-5xl gap-4 sm:mt-16 sm:grid-cols-2 sm:gap-5">
                <div class="rounded-[1.5rem] bg-brillia-black px-6 py-9 text-center sm:px-8 sm:py-10 sm:text-left">
                    <p class="text-[0.6875rem] font-bold uppercase tracking-[0.14em] text-brillia-lime">New partners</p>
                ...
                <div class="rounded-[1.5rem] bg-white px-6 py-9 text-center shadow-[0_10px_40px_rgba(0,0,0,0.06)] sm:px-8 sm:py-10 sm:text-left">
                    <p class="text-[0.6875rem] font-bold uppercase tracking-[0.14em] text-brillia-lime">Existing partners</p>
                    <h2 class="mt-3 text-xl font-extrabold tracking-tight text-brillia-ink sm:text-2xl">
                    ...
                    <a
                        ...
                        class="mt-6 inline-flex items-center gap-2.5 rounded-full bg-brillia-black py-3 pl-6 pr-2.5 text-sm font-semibold text-white transition hover:bg-neutral-800"
                    >
                        Partner login
