...
@section('title', 'How Brillia works — Compare and switch in 3 steps')
@section('meta_description', 'See how Brillia works: enter a few details, compare live UK energy deals, and switch with confidence — usually in under a minute to find your options.')
...
@section('content')
    <section class="bg-[#f3f3f3] py-14 sm:py-20">
        <div class="mx-auto max-w-7xl px-5 sm:px-8 lg:px-10">
            ...
            <div class="mx-auto mt-12 max-w-5xl overflow-hidden rounded-[1.5rem] bg-brillia-black px-6 py-10 text-center sm:mt-16 sm:px-10 sm:py-12">
